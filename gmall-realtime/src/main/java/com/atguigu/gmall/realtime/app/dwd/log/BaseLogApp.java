...
//        env.getCheckpointConfig().setCheckpointStorage("hdfs://mycluster/gmall/ck");
...
//        System.setProperty("HADOOP_USER_NAME", "atguigu");
        ...
        SingleOutputStreamOperator<String> source = env
                ...
                .uid("BaseLogApp-source-1")
                .name("BaseLogApp-source-1");
        ...
        SingleOutputStreamOperator<JSONObject> cleanedStream = source.process(
                ...
                .uid("BaseLogApp-process-2")
                .name("BaseLogApp-process-2");
        ...
        dirtyStream
                .addSink(KafkaUtil.getKafkaProducer(dirtyTopic))
                .uid("BaseLogApp-sink-3")
                .name("BaseLogApp-sink-3");
        ...
        SingleOutputStreamOperator<JSONObject> fixedStream = keyedStream.process(
                ...
                .uid("BaseLogApp-process-4")
                .name("BaseLogApp-process-4");
        ...
        SingleOutputStreamOperator<String> separatedStream = fixedStream.process(
                ...
                .uid("BaseLogApp-process-5")
                .name("BaseLogApp-process-5");
...
//        separatedStream.getSideOutput(errorTag).print("error$$$");
        ...
        separatedStream.addSink(KafkaUtil.getKafkaProducer(page_topic))
                .uid("BaseLogApp-sink-page-6")
                .name("BaseLogApp-sink-page-6");
        startDS.addSink(KafkaUtil.getKafkaProducer(start_topic))
                .uid("BaseLogApp-sink-start-6")
                .name("BaseLogApp-sink-start-6");
        displayDS.addSink(KafkaUtil.getKafkaProducer(display_topic))
                .uid("BaseLogApp-sink-display-6")
                .name("BaseLogApp-sink-display-6");
        actionDS.addSink(KafkaUtil.getKafkaProducer(action_topic))
                .uid("BaseLogApp-sink-action-6")
                .name("BaseLogApp-sink-action-6");
        errorDS.addSink(KafkaUtil.getKafkaProducer(error_topic))
                .uid("BaseLogApp-sink-error-6")
                .name("BaseLogApp-sink-error-6");
